<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contestentries.aspx.cs"
    Inherits="AWAPI.Admin.frames.contestentries" %>
                ...
                <asp:GridView ID='_list' runat='server' AutoGenerateColumns="False" BorderStyle="None"
                    ...
                    <Columns>
                        <asp:BoundField DataField="createdate" HeaderText="Date" SortExpression="createDate"
                            DataFormatString="{0:MM/dd HH:mm}" ItemStyle-Wrap="false">
                            <ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Email" HeaderStyle-HorizontalAlign="Left" SortExpression="email">
                            <ItemTemplate>
                                <strong>
                                    <asp:Label ID="customFieldTitleInList" runat='server' Text='<%# Bind("email") %>' /></strong>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="180" Wrap="True" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="isEnabled" HeaderText="Enabled" SortExpression="isEnabled" />
